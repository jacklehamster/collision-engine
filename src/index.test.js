...
describe('CollisionMixer', function() {
  it('should detect collisions', async function() {
    ...
    expect(overlaps.has("box1-box2")).to.be.true;
    expect(overlaps.has("box2-box1")).to.be.true;
    ...
    expect(overlaps.has("box1-box3")).to.be.true;
    expect(overlaps.has("box3-box1")).to.be.true;
    expect(overlaps.size).to.equal(2);
  });
});